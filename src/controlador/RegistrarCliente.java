...
public class RegistrarCliente {
    ...
    public boolean actualizarCliente(Cliente cli) {
        ...
        try {
            ...
            cnx = cbd.obtenerConeccion();
                       ...
                       String query = "UPDATE INTO cliente(idCliente,nombre,apellido,celular,fecha,modalidad,modelo,tipoServicio,valor,estado ) VALUES (?,?,?,?,?,?,?,?,?,?)";
            try (PreparedStatement stmt = cnx.prepareStatement(query)) {
                ...
                stmt.executeUpdate(); //actualiza cliente
            }
            cnx.close();
            return true;
        } catch (SQLException e) {
            System.out.println("Error SQL al egresar Cliente" + e.getMessage());
            return false;
        } catch (Exception e) {
            System.out.println("Error al egresar Cliente" + e.getMessage());
            return false;
        }
    }
    ...
    //egresar cliente
       public boolean egresarCliente(Cliente cli) {
        List<Cliente> lista = new ArrayList<>();
